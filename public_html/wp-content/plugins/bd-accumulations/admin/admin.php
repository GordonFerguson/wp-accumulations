...
{
   add_menu_page(
      __('Accumulations', 'bd324-accmulations'),
      __('Accumulations', 'bd324-accmulations'),
      'manage_options',
      'bd-accumulations',
...
function bd324_acc_settings_init()
{
   ...
   add_settings_field(
      ...
      __('Add Accumulations', 'aq-data-foobot'), // Label
...
?>
   <input type='email' name='bd324_acc_api_settings[bd324_acc_api_user]' placeholder='<?php _e("Your API email", 'aq-data-foobot'); ?>' value='<?php echo esc_html($options['bd324_acc_api_user']); ?>'>
<?php
}
...
function bd324_acc_api_key_field_render()
{
   $options = get_option('bd324_acc_api_settings');
?>
   <textarea rows="7" cols="50" name='bd324_acc_api_settings[bd324_acc_api_key]' placeholder='<?php _e("Your API key", 'aq-data-foobot'); ?>'><?php echo esc_textarea($options['bd324_acc_api_key']); ?></textarea>
<?php
}
/**
...
?>
   <div class="wrap">
      <form action='options.php' method='post'>
         ...
         <h1><?php _e("Accumulations", 'aq-data-foobot'); ?></h1>
         <?php
